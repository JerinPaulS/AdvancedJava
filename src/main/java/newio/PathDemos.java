...
public class PathDemos {
    ...
    public static void main(String[] args) {
        ...
        Path dictionary = Paths.get("/", "home", "cromp", "Downloads", "Tickets");
        System.out.println(dictionary);

        Path home = Paths.get("/home/cromp/");
        ...
        // Normalize a path
        Path p = Paths.get("/home/cromp/Downloads/Tickets/./Survey Paper/..").normalize();
